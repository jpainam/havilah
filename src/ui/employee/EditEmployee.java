...
public class EditEmployee extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jtSSN = new javax.swing.JTextField(employee.getMatric());
        jtFirstName = new javax.swing.JTextField(employee.getFname());
        jtLastName = new javax.swing.JTextField(employee.getLname());
        jLabel5 = new javax.swing.JLabel();
        jLabel6 = new javax.swing.JLabel();
        jLabel7 = new javax.swing.JLabel();
        jLabel8 = new javax.swing.JLabel();
        jtAddress = new javax.swing.JTextField(employee.getAddress());
        jtTelephon = new javax.swing.JTextField(employee.getPhone());
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(813, 473));
        ...
        jLabel9.setText("EDIT EMPLOYEE FORM");
    ...
    public String getSqlDob(){
        if(jxDateBirth.getDate() != null && !jxDateBirth.getDate().toString().isEmpty()){
    ...
    private void jbValidateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbValidateActionPerformed
        ...
        if(DBStudent.updateData(emp)){
            JOptionPane.showMessageDialog(null, "Employee updated with success");
        }else
        JOptionPane.showMessageDialog(null, "Error in updating the employee");
